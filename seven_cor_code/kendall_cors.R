...
normal_gene_cor<-cor(normal,method = 'kendall')
tumor_gene_cor<-cor(tumor,method = 'kendall')
...
write.csv(pearson_cors,'ke_all_cors.csv')
...
#write.csv(p_order_cors,'ke_order_cors.csv')
