...
tumor_gene_cor<-mine(tumor,n.cores=48)$MIC

normal_gene_cor<-mine(normal,n.cores=48)$MIC
...
write.csv(pearson_cors,'mic_all_cors.csv')
...
#write.csv(p_order_cors,'mic_order_cors.csv')
