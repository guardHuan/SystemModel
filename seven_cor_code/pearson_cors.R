...
normal_gene_cor<-cor(normal,method = 'pearson')
tumor_gene_cor<-cor(tumor,method = 'pearson')
...
write.csv(pearson_cors,'pearson_all_cors.csv')
...
#write.csv(p_order_cors,'pearson_order_cors.csv')
